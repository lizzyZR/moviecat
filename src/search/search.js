(function (angular) {
    var app = angular.module("moviecat_search", ["ngRoute", "jsonp"]);
    ...
    app.controller("searchController", ["$scope", "jsonp", "$routeParams", "$window", "$route", function ($scope, jsonp, $routeParams, $window, $route) {
        $scope.pageNum = 10;
